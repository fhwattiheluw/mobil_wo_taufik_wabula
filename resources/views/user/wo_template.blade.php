        ...
        <nav style="bottom: 0;" class="orange lighten-5"> <!-- navbar bottom -->
          <div class="nav-wrapper center">
            <ul id="nav-mobile" >
              ...
              <li>
                <a class="btn-floating btn-large  green accent-4" href="https://api.whatsapp.com/send?phone={{ $about[0]->nomor_hp }}&text=halo {{$about[0]->nama}}" target="_blank"><i class="large material-icons">message</i></a>
              </li>
